...
<header class="profile main-profile" itemscope itemtype="http://schema.org/Person">
	...
	<a href="<?php bloginfo('url') ?>">
		<<?php if (is_amp()) : ?>amp-img<?php else : ?>img<?php endif ?> src="<?php echo get_theme_mod('profile_image') ?>" class="img" alt="profile image" draggable="false" height="200" width="200" itemprop="image"><?php if (is_amp()) : ?></amp-img><?php endif; ?>
	</a>
	<h1>
